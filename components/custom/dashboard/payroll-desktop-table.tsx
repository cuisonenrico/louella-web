...
export function PayrollDesktopTable({ entries, isFiltering, itemsPerPage, formatCurrency }: PayrollDesktopTableProps) {
  return (
    <div className={`hidden sm:block rounded-lg border overflow-hidden transition-all duration-300 ${
        ...
        <table className="w-full">
          <thead className="bg-muted/50">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Payroll Period</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Rate</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Gross</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Deductions</th>
              <th className="px-4 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Net</th>
            </tr>
          </thead>
